/**
 * The male gametes or sperm cells in humans and other mammals
 ...
 * fertilizes an egg, the resulting zygote will be XX or female. If the sperm cell contains a Y chromosome,
...
public class Main {
    ...
    public static void main(String[] args) {
        String str = "XX";
        System.out.println(chromosomeCheck(str));
    }
